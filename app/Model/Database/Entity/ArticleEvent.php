...
use App\Model\Database\Utils\ABaseEntity;
use Nette\Utils\DateTime;

/**
 * @ORM\Entity(repositoryClass="App\Model\Database\Repository\ArticleEventRepository")
 * @ORM\Table(name="`article_event`")
 */
class ArticleEvent extends AbstractEntity
{
    use TId;
     ...
     * FORM type='text'
     * FORM title="Začátek akce"
     * FORM attribute-class='form-control input-md'
     * FORM required='Toto pole je povinné'
     * FORM attribute-placeholder='Začátek akce'
     * 
     * GRID type='datetime'
     * GRID title="Začátek akce"
     * GRID sortable='true'
     * GRID filter='single'
     * GRID visible='true'
     */
     ...
     * @ORM\Column(type="boolean")
     * FORM type='checkbox'
     * FORM title="Upřednostňovat na HP"
     * FORM default-value='true'
     *
     * GRID type='bool'
     * GRID title="Na HP"

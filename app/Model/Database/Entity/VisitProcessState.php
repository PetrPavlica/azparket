...
/**
 * @ORM\Entity(repositoryClass="App\Model\Database\Repository\VisitProcessStateRepository")
 * @ORM\Table(name="`visit_process_state`")
 * @ORM\HasLifecycleCallbacks
 */
class VisitProcessState extends AbstractEntity
{
    use TId;
    use TCreatedAt;
    use TUpdatedAt;

...
/**
 * @ORM\Entity(repositoryClass="App\Model\Database\Repository\ArticleDefaultRepository")
 * @ORM\Table(name="`article_default`")
 */
class ArticleDefault extends AbstractEntity
{

...
class ImageStorageExtension extends Nette\DI\CompilerExtension
{
	...
	public function beforeCompile()
	{
		...
		$service = $builder->getDefinition('nette.latteFactory')->getResultDefinition();
		$service->addSetup('Ublaboo\ImageStorage\Macros\Macros::install(?->getCompiler())', array('@self'));
	}
